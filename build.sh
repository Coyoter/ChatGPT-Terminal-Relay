...
/usr/libexec/PlistBuddy -c "Add :CFBundleVersion string 0.4.0" "$PLIST"
...
ditto -c -k --sequesterRsrc --keepParent \
  "$APP" \
  "$DIST/ChatGPT-Terminal-Relay-v0.4.0-macOS.zip"

echo "BUILD_OK"
echo "$DIST/ChatGPT-Terminal-Relay-v0.4.0-macOS.zip"
