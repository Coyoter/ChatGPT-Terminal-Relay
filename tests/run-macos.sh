...
clang -DRELAY_TESTING -fobjc-arc -fblocks -mmacosx-version-min=13.0 "$ROOT/tests/RelayTests.m" "$ROOT/src/RelayDelivery.m" "$ROOT/src/RelayDiagnostics.m" \
...
clang -DRELAY_TESTING -fobjc-arc -fblocks -mmacosx-version-min=13.0 "$ROOT/tests/AXDiscoveryTests.m" "$ROOT/src/RelayDiagnostics.m" \
